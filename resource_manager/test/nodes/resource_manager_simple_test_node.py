#! /usr/bin/env python
from resource_manager.resource_manager_base import ResourceManagerSimple # pylint: disable=import-error, no-name-in-module
...
class ResourceManagerTestNode(ResourceManagerNode):
    ...
    def clear_manager(self, req):
        ...
        self.request_queue = []
        for group in self.manager._resources_groups:
...
if __name__ == "__main__":
    ResourceManagerTestNode(manager=ResourceManagerSimple(infix='', index=1)).run()